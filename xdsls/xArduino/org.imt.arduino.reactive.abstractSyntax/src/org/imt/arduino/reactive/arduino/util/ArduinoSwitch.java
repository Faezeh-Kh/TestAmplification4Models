...
public class ArduinoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ArduinoPackage.MODULE: {
				org.imt.arduino.reactive.arduino.Module module = (org.imt.arduino.reactive.arduino.Module)theEObject;
	 ...
	 * @generated
	 */
	public T caseModule(org.imt.arduino.reactive.arduino.Module object) {
		return null;
	}
